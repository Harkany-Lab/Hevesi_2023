...
```{r pl-init-dr, fig.align='center', fig.asp=1.618, fig.width=9}
...
DimPlot_scCustom(combined.srt, reduction = "pca")
...
FeaturePlot_scCustom(combined.srt, features = "percent_mt", colors_use = combined.srt@misc$mdat_Colour_Pal) & 
  theme(plot.title = element_text(size = 16))

FeaturePlot_scCustom(combined.srt, features = "percent_mt", colors_use = combined.srt@misc$mdat_Colour_Pal, na_cutoff = 5)
...
```{r}
DimPlot_scCustom(combined.srt, pt.size = 3, group.by = "QC")
```
...
```{r fig.align='center', fig.asp=.618, fig.width=5}
FeaturePlot_scCustom(combined.srt,features = "percent_mt", label.size = 4, repel = T, pt.size = 3, label = T, colors_use = combined.srt@misc$mdat_Colour_Pal)  & 
  theme(plot.title = element_text(size = 16))
```
...
```{r fig.align='center', fig.asp=.618, fig.width=5}
FeaturePlot_scCustom(combined.srt, features = "percent_rb",
