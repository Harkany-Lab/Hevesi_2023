...
Expression of glutamate receptors in glutamatergic Gal positive cells
```{r plot-dotplot-glur-glu-neurons, fig.width=7, fig.asp=.5}
DotPlot(object = neuro_fin_neurotrans$glutamatergic,
        features = glutr,
        group.by = "k_tree",
        cols = c("#ffc2c2", "#ff3c00"),
...
```{r pl-stckvlnplot-vglut2-rna, fig.align='center', fig.width=4, fig.asp=0.618}
p4 <- Stacked_VlnPlot(
  seurat_object = srt_vglut2,
  assay = "RNA",
  features = genes_present$found_features,
...
p1 | p2 | p3
```
```{r pl-fig2d-alt, fig.align='center', fig.width=18, fig.asp=0.206}
p1 | p2 | p4
```
